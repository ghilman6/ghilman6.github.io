	...
	<body class="sidebar-mini wysihtml5-supported <?= $this->config->item('color')?>">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<button class="btn btn-primary" onclick='ViewData(0)'>
										<i class='fa fa-plus'></i> Add Business Unit Access
									</button>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													<input type="hidden" id="id_bu" name="id_bu" value='<?= $id_bu?>' />
													<input type="hidden" id="id_bu_access" name="id_bu_access" value='0' />
		...
		<script type='text/javascript'>
			var buTable = $('#buTable').DataTable({
				...
				ajax: 
				{
					url: "<?= base_url() ?>bu/ax_data_bu_access/<?= $id_bu?>",
					type: 'POST'
				},
				columns: 
				[
					{
						data: "id_bu_access", render: function(data, type, full, meta){
							var str = '';
			...
			$('#btnSave').on('click', function () {
				...
				{
					var url = '<?=base_url()?>bu/ax_set_data_access';
					var data = {
						id_bu: $('#id_bu').val(),
			...
			function ViewData(id_bu_access)
			{
				...
				{
					var url = '<?=base_url()?>bu/ax_get_data_access_by_id';
					var data = {
			...
			function DeleteData(id_bu_access)
			{
				alertify.confirm(
					...
					function(){
						var url = '<?=base_url()?>bu/ax_unset_data_access';
						var data = {
							id_bu_access: id_bu_access
						};
