				...
				<div class="row">
					...
					<div class="col-lg-7">
						<ul class="nav nav-tabs">
							...
							<li><a data-toggle="tab" href="#chat_disposisi">Disposisi</a></li>
						...
						<div class="tab-content">
							...
							<div id="chat_disposisi" class="tab-pane fade ">
									<!---------------- SECTION DISPOSISI ------------------->
								<div class="panel-group" id="accordion3">

									<div class="panel panel-primary">
										<div class="panel-heading accordion-toggle pointer" data-toggle="collapse" data-parent="#accordion3" href="#collapse8">
											<h4 class="panel-title">
												<span>
													Disposisi</span>
											</h4>
									...
									<!---------------- SECTION LIST DISPOSISI ------------------->

									<div class="panel panel-primary">
										<div class="panel-heading accordion-toggle pointer" data-toggle="collapse" data-parent="#accordion3" href="#collapse9">
											<h4 class="panel-title">
												<span>
													List Disposisi</span>
											</h4>
										...
										<div class="panel-body">
											...
											<h3 class="text-center" id="pilih_disposisi_dulu">Pilih Disposisi Di Bawah Untuk Di Menampilkan !</h3>
											...
											<hr>
											<div class="col-lg-12">
												<p style ="color:red;padding-top: 30px;">*Pilih Disposisi Dalam Table Dibawah ini :</p>
												<table class="table table-striped table-bordered table-hover" id="tbllistdispo">
													<thead>
														<tr>
															<th>Type </th>
															<th>Kode Surat</th>
...
<script>
	...
	$("#accordion, #accordion2, #accordion3").on("shown.bs.collapse", function() {
...
<script type='text/javascript'>
	...
	const getDisposisiBySurat = () => {
		...
		if(id_surat_selected != null ){
			...
			tbllistdispo = $('#tbllistdispo').DataTable({
				"bDestroy": true,
				"ordering" : false,
				"scrollX": true,
				"processing": true,
				...
				"ajax": 
				{
					"url": "<?=base_url()?>inbox/ax_data_disposisi/",
					"type": 'POST',   
					"data": data
	...
	$('#tbllistdispo tbody').on('click','tr',function(){
		var data = $('#tbllistdispo').DataTable().row(this).data();
		console.log(data);
		if(data != null){
			id_disposisi_selected = data.id_disposisi;
			chatdisposisi(id_disposisi_selected);
			selectDisposisi(id_disposisi_selected);
